...
from core.utils.data.text import ANSWER_OPEN_FOLDER, SHUTDOWN_INLINE, CANCEL_MSG, ANSWER_NOT_FOUND_FILE
...
async def find_file(call: CallbackQuery, bot: Bot, callback_data: FolderInfo):
    ...
    if list_files:
        ...
        answer = ANSWER_NOT_FOUND_FILE
        await call.message.answer(answer, reply_markup=None)
...
async def upload_file(call: CallbackQuery, bot: Bot, callback_data: FileInfo):
    ...
    if filename == "download_all":
        ...
        await del_archive(archive_folder)
